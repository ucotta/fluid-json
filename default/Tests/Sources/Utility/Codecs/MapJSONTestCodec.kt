...
internal object MapJSONTestCodec : AbstractJSONCodec<Map<*, *>, JSONCodingContext>(
	...
	override fun decode(valueType: JSONCodableType<in Map<*, *>>, decoder: JSONDecoder<JSONCodingContext>) =
	...
	object NonRecursive : AbstractJSONCodec<Map<String, *>, JSONCodingContext>(
		...
		override fun decode(valueType: JSONCodableType<in Map<String, *>>, decoder: JSONDecoder<JSONCodingContext>) =
