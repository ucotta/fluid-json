...
internal object StandardSerializerRejectSpec : SubjectSpek<JSONCodingSerializer>({

	subject {
		StandardCodingSerializer(JSONCodingContext.empty) { destination, context ->
	...
	describe("StandardCodingSerializer rejects serialization of") {
...
private fun JSONCodingSerializer.failToSerialize(value: Any?) {
	try {
