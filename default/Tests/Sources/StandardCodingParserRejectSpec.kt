...
internal object StandardCodingParserRejectSpec : SubjectSpek<JSONCodingParser>({

	subject {
		StandardCodingParser(JSONCodingContext.empty) { source, context ->
...
private fun JSONCodingParser.failToParse(string: String) {
